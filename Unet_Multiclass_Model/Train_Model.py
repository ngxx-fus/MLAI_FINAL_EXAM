...
# my_ss_model
n_classes = 21
my_ss_model = Unet_Model(n_classes).to(device) # GPU trainning
my_ss_model.load_state_dict(torch.load("/content/drive/MyDrive/FINAL_PROJECT_MLAI/model_ep.pth"))
...
#    if ep >= 25:
    torch.save(my_ss_model.state_dict(), root_path + "\\model_ep.pth".format(ep))